...
public class MyDate {
	...
	public void setYear(int year) {
		if (isValidDate(year, month, day)) throw new IllegalArgumentException("Invalid year!");
		this.year = year;
	}

	public void setMonth(int month) {
		if (isValidDate(year, month, day)) throw new IllegalArgumentException("Invalid month!");
		this.month = month;
	}
