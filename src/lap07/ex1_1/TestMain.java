...
//		System.out.println(shape1.getRadius());		//	Cannot resolve method 'getRadius' in 'Shape'
...
//		Shape shape2 = new Shape();		// 'Shape' is abstract; cannot be instantiated
...
//		System.out.println(shape3.getLength());		// Cannot resolve method 'getLength' in 'Shape'
...
//		System.out.println(shape4.getSide());	// Cannot resolve method 'getSide' in 'Shape'
		
		Rectangle rectangle2 = (Rectangle) shape4;
		System.out.println(rectangle2);
		System.out.println(rectangle2.getArea());
		System.out.println(rectangle2.getColor());
//		System.out.println(rectangle2.getSide());	// Cannot resolve method 'getSide' in 'Rectangle'
